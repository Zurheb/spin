...
export function StickyNavbar() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 mx-auto">
      <Typography as="li" variant="h6" className="p-1 hover:scale-110  font-normal">
        ...
        <Navbar className=" h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 bg-black">
          <div className="flex  items-center justify-between ">
            <div className="flex gap-24">
              ...
              >
                <img
                  className="w-auto hover:scale-105 h-auto max-h-4 lg:max-h-6"
            ...
            <div className="hidden lg:flex items-center gap-5">
              <Button
                variant="text"
                className="text-white hover:scale-105 bg-blue-gray-900 hover:bg-yellow-600"
              >
                <span>Subscribe</span>
              </Button>
              <Button
                variant="text"
                className="text-white hover:scale-105 bg-blue-gray-900 hover:bg-blue-500"
              >
